...
├── src/               # 源代码目录
│   ├── step01_encoding/convert_encoding.py    # 编码转换工具 ✅
│   ├── step02_chapter/chapter_visualizer.py  # 章节结构可视化工具 ✅
│   ├── step03_character/character_extractor.py # 人物提取（待开发）
│   ├── step04_dialogue/dialogue_separator.py  # 对话分离（待开发）
│   └── step05_formatting/data_formatter.py      # 数据格式化（待开发）
├── doc/               # 文档目录
│   ├── 00-overall-plan.md      # 总体计划（本文档）
│   ├── 01-encoding-conversion.md # 编码转换文档
│   ├── 02-chapter-recognition.md # 章节识别文档（待创建）
│   ├── 03-character-extraction.md # 人物提取文档（待创建）
│   ├── 04-dialogue-separation.md  # 对话分离文档（待创建）
│   └── 05-data-formatting.md     # 数据格式化文档（待创建）
└── output/            # 输出结果目录
